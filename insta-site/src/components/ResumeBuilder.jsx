      ...
      <div className="flex flex-col items-center mb-4">
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-4">
            <input className="border px-2 py-2 rounded" type="text" placeholder="Resume ID" value={resumeId} onChange={e => setResumeId(e.target.value)} style={{width:'180px', maxWidth: '180px'}} />
            <button className="px-3 py-2 bg-green-600 text-white rounded" onClick={handleLoadFromCloud} type="button">Load</button>
            <button className="px-3 py-2 bg-blue-600 text-white rounded" onClick={handleSaveToCloud} type="button">Save to Cloud</button>
          </div>
          <span className="text-sm">{cloudStatus}</span>
        </div>
